...
class HTTPClient:
    ...
    async def post(
        ...
        """Make POST request."""
        if json_data:
            return await self._make_request('POST', endpoint, json=json_data, headers=headers)
        else:
    ...
    async def put(
        ...
        """Make PUT request."""
        if json_data:
            return await self._make_request('PUT', endpoint, json=json_data, headers=headers)
        else:
