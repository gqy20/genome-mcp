...
class QueryResult(BaseModel):
    ...
    sources: List[DataSource] = Field(default_factory=list, description="Data sources used")
    confidence: ConfidenceLevel = Field(ConfidenceLevel.UNKNOWN, description="Result confidence")
