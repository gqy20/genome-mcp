"""
Core utility functions for Genome MCP.
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    if attempt < max_retries:
                        ...
                        logger.error("Max retries exceeded for function %s", func.__name__)
